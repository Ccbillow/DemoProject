...
import org.example.handler.EmailNoticeHandler;
...
public class UserServiceTest {
    ...
    @MockBean
    private EmailNoticeHandler noticeHandler;
    ...
    public void testAdd_Success() {
        ...
        Mockito.doReturn(noticeHandler).when(noticeHandlerFactory).getHandler(any());
        Mockito.doNothing().when(noticeHandler).handleNotice(any());
        userService.add(request);
    }
